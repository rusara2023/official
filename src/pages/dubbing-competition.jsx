          ...
          <main>
            ...
            සංස්කෘතික හුවමාරුව පෝෂණය කිරීම.`}
              ...
              {isEng ? (
                ...
                <ul className="mt-4 ml-4">
                  <li className="mt-2">● ඔබගේ හඬ කැවීම් පිටපත (script) ඔබගේ ks¾udKයක් විය යුතුය.</li>
                  <li className="mt-2">
                    ● අපගේ ගෙබ් අඩවිගයහි පළකර ඇති එක් එක් කාණ්ඩ ඔසේගසේ වූ වීඩිගයෝ එකක් ගතෝරාගෙන එක් වීඩිගයෝෙ බැගින් කාණ්ඩ ගෙගකන් වීඩිගයෝ clips ගෙකක් සඳහා හඬ
                    කැවීම් කළ යුතුය.
                  </li>
